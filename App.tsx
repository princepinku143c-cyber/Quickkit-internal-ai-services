...
const App: React.FC = () => {
  ...
  const renderLandingView = () => <div className="bg-[#030712] min-h-screen font-sans text-slate-100 selection:bg-blue-500/30">
    <Helmet>
      <title>Real Estate AI Automation Agency India | Managed AI Agents | QuickKit AI</title>
      <meta name="description" content="QuickKit AI builds and manages AI agents for Indian real estate teams: property lead intake, qualification, WhatsApp follow-up, AI calling, site-visit workflows and CRM automation."/>
