...
const App: React.FC = () => {
  ...
  const renderLandingView = () => <div className="bg-[#030712] min-h-screen font-sans text-slate-100 selection:bg-blue-500/30">
    <Helmet>
      <title>Real Estate AI Automation Agency India | Managed AI Teammates | QuickKit AI</title>
      <meta name="description" content="QuickKit AI builds and manages AI teammates for Indian real estate teams: property lead intake, qualification, WhatsApp follow-up, AI calling, site-visit workflows and CRM automation."/>
      <meta name="keywords" content="real estate AI automation agency India, real estate AI agents India, property lead generation AI, real estate lead qualification AI, WhatsApp AI for real estate, AI calling for real estate, site visit automation, real estate CRM automation, builder AI automation, broker AI automation, AI workforce for real estate, managed AI agents real estate"/>
      <meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"/>
      <link rel="canonical" href="https://quickkitai.com"/>
    </Helmet>
    <Navbar onContact={()=>handleOpenLeadForm()} isAuthenticated={isAuthenticated}/><Hero lang={lang} onLaunchArchitect={handleLaunchArchitect}/><IntegrationMarquee/>
