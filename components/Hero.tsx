  ...
  return (
    <section id="hero" className="relative min-h-[92vh] flex items-center justify-center pt-24 overflow-hidden bg-nexus-dark">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        <p className="text-xs text-slate-500 max-w-2xl mx-auto mb-10">Built for Indian real estate workflows. AI/API usage is billed separately according to actual usage; setup and maintenance are shown in INR.</p>
        <div className="flex flex-wrap justify-center gap-6 border-t border-nexus-border/30 pt-8 w-full max-w-3xl mx-auto"><div className="flex items-center gap-2 text-[10px] font-mono text-slate-500 uppercase tracking-widest"><Bot className="w-3.5 h-3.5 text-blue-500" /> Lead Qualification</div><div className="flex items-center gap-2 text-[10px] font-mono text-slate-500 uppercase tracking-widest"><Server className="w-3.5 h-3.5 text-purple-500" /> Managed AI Infrastructure</div><div className="flex items-center gap-2 text-[10px] font-mono text-slate-500 uppercase tracking-widest"><ShieldCheck className="w-3.5 h-3.5 text-emerald-500" /> Monitoring & Maintenance</div></div>
      </div>
    </section>
  );
};
