...
import { ShieldCheck, Zap, Cpu, Server, Bot, Sparkles, ArrowRight } from 'lucide-react';
    ...
    <section id="hero" className="relative min-h-[92vh] flex items-center justify-center pt-24 overflow-hidden bg-nexus-dark">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-mono text-emerald-400 mb-8 tracking-[0.2em] uppercase font-black">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" /> Managed AI Systems for Indian Businesses
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight tracking-tighter text-white animate-slide-up">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-emerald-400">Managed AI Employees</span>
          <br />
          built for your business
        </h1>

        <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto mb-8 leading-relaxed">
          We build, deploy, operate and maintain AI agent systems for sales, support, CRM, WhatsApp, voice, marketing and business workflows — so you get the automation without managing the infrastructure.
        </p>
        ...
        <div className="max-w-2xl mx-auto mb-8 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button
            onClick={() => onLaunchArchitect('Show me how QuickKitAI can automate my business and recommend the right AI agents and infrastructure.')}
        ...
        <p className="text-xs text-slate-500 max-w-2xl mx-auto mb-10">AI/API usage is billed separately according to actual usage. Setup and maintenance are transparent and shown in INR.</p>
